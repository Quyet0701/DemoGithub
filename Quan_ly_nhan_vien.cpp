...
class Employee{
	...
	public:
	    Employee(int _id,std::string _name, int _age,double _salary): id(_id),name(_name),age(_age),salary(_salary){}
...
class Manager: public Employee{
	private:
		int teamSize;
	public:
	    Manager(int _id,std::string _name,int _age,double _salary,int _teamSize):Employee(_id,_name,_age,_salary),teamSize(_teamSize){}
...
int main(){
	...
	myCompany.addEmployee(new Employee(1,"Nguyen Van A",30,100000000));
	myCompany.addEmployee(new Employee(2,"Tran Thi B",25,800000000));
